export const TELA_PADRAO = {name: '', title: "Soneca Saúde"};
...
export const TELA_ESQUECI_SENHA = {name:"esqueciSenha", title: "Esqueci a senha"};
    ...
    /**cadastro */
export const TELA_CADASTRO_PERFIL = {name:"cadastroPerfil", title:"Cadastro"};
...
export const TELA_DETALHE_MEDICAMENTO = {name: "detalheMedicamentos", title: "Detalhes do medicamento"};
