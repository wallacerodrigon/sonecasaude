    ...
    render() {
        return (
            <View style={[EstilosComuns.container]}>
                <Text style={[EstilosComuns.corVerde, EstilosComuns.textoJustificado]}>
                    Para recuperar sua senha, informe o seu e-mail de cadastro abaixo e você receberá um link para 
                    ativação da sua conta com uma nova senha.
